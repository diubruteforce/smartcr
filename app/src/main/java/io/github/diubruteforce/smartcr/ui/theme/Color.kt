...
@Composable
val Colors.grayText: Color get() = AmbientContentColor.current.lighten(0.55f)

@Composable
val Colors.grayBackground: Color get() = MaterialTheme.colors.background.darken(0.05f)